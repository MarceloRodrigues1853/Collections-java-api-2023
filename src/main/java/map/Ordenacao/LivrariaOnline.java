...
// Classe representando uma livraria online
public class LivrariaOnline {
    // Mapa para armazenar os livros, onde a chave é o link do livro e o valor é o objeto Livro
    ...
    // Método para exibir todos os livros ordenados por preço
    ...
    // Método para exibir todos os livros ordenados por autor
    ...
    public List<Livro> obterLivroMaisCaro() {
        ...
        for (Map.Entry<String, Livro> entry : livros.entrySet()) {
            if (entry.getValue().getPreco() == precoMaisAlto) {
                livrosMaisCaros.add(livros.get(entry.getKey()));
            }
        }
    ...
    // Método main para testar a classe LivrariaOnline
